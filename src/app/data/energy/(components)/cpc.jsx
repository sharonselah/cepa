...
const AfricaMapCPC = () => {
    ...
    const { countryData, containerRef, svgRef } = useD3Map("Cost Per Capacity", 500);

    useEffect(() => {
        d3.json("https://raw.githubusercontent.com/janasayantan/datageojson/master/geoAfrica.json")
            .then((data) => {
                renderD3Map(data, countryData, containerRef, svgRef, d3.interpolateBlues, "Cost Per Capacity", 500, "Dollars");
            });
    }, [countryData]);
